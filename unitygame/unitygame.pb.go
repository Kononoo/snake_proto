...
const (
	...
	SnakeOpType_Command             SnakeOpType = 6002
	SnakeOpType_Signal              SnakeOpType = 6003
	SnakeOpType_HistoryFrame        SnakeOpType = 6004
	SnakeOpType_Snapshot            SnakeOpType = 6005
	SnakeOpType_CheckSum            SnakeOpType = 6006
	SnakeOpType_Bind                SnakeOpType = 6010
	SnakeOpType_HeartBeat           SnakeOpType = 6011
	SnakeOpType_ReportScore         SnakeOpType = 6012
	SnakeOpType_ExitGame            SnakeOpType = 6013
	SnakeOpType_Action              SnakeOpType = 6014
	SnakeOpType_ReportRoomLockState SnakeOpType = 6015
	SnakeOpType_Loading             SnakeOpType = 6016
	SnakeOpType_ReportKuromiScore   SnakeOpType = 6017
	SnakeOpType_PuGameStart         SnakeOpType = 6101
	SnakeOpType_PuFrame             SnakeOpType = 6102
	SnakeOpType_PuSignal            SnakeOpType = 6103
	SnakeOpType_PuAbnormal          SnakeOpType = 6104
	SnakeOpType_PuGameEnd           SnakeOpType = 6105
	SnakeOpType_PuLoading           SnakeOpType = 6106
	SnakeOpType_PuScoreAbnormal     SnakeOpType = 6107 // 成绩异常
)
...
var (
	SnakeOpType_name = map[int32]string{
		...
		6013: "ExitGame",
		6014: "Action",
		6015: "ReportRoomLockState",
		6016: "Loading",
		6017: "ReportKuromiScore",
		6101: "PuGameStart",
		6102: "PuFrame",
		6103: "PuSignal",
		6104: "PuAbnormal",
	...
	SnakeOpType_value = map[string]int32{
		...
		"ExitGame":            6013,
		"Action":              6014,
		"ReportRoomLockState": 6015,
		"Loading":             6016,
		"ReportKuromiScore":   6017,
		"PuGameStart":         6101,
		"PuFrame":             6102,
		"PuSignal":            6103,
		"PuAbnormal":          6104,
...
type ReportKuromiScoreReq struct {
	...
	ScoreList []*KuromiPlayerScore `protobuf:"bytes,1,rep,name=score_list,json=scoreList,proto3" json:"score_list,omitempty"`
...
func (x *ReportKuromiScoreReq) GetScoreList() []*KuromiPlayerScore {
	if x != nil {
		return x.ScoreList
	}
	return nil
...
type KuromiPlayerScore struct {
	...
	Uid string `protobuf:"bytes,1,opt,name=uid,proto3" json:"uid,omitempty"`
	// 游戏数据
	Length               int32    `protobuf:"zigzag32,2,opt,name=length,proto3" json:"length,omitempty"`                                                              // 长度
	Kill                 int32    `protobuf:"zigzag32,3,opt,name=kill,proto3" json:"kill,omitempty"`                                                                  // 击杀数量
	ItemScores           []int32  `protobuf:"zigzag32,4,rep,packed,name=item_scores,json=itemScores,proto3" json:"item_scores,omitempty"`                             // 拾取道具
	ReviveCount          int32    `protobuf:"zigzag32,5,opt,name=revive_count,json=reviveCount,proto3" json:"revive_count,omitempty"`                                 // 复活次数
	EventIds             []string `protobuf:"bytes,6,rep,name=event_ids,json=eventIds,proto3" json:"event_ids,omitempty"`                                             // 触发事件（勇往直前...）分数
	Eat                  int32    `protobuf:"zigzag32,7,opt,name=eat,proto3" json:"eat,omitempty"`                                                                    // 累计长度，只加不减
	KilledNum            int32    `protobuf:"zigzag32,8,opt,name=killed_num,json=killedNum,proto3" json:"killed_num,omitempty"`                                       // 被击杀次数
	DestroyLength        int32    `protobuf:"zigzag32,9,opt,name=destroy_length,json=destroyLength,proto3" json:"destroy_length,omitempty"`                           // 击杀的敌人的长度的累加
	CollectColorDotScore int32    `protobuf:"zigzag32,10,opt,name=collect_color_dot_score,json=collectColorDotScore,proto3" json:"collect_color_dot_score,omitempty"` // 收集彩点分数
	HitWallTimes         int32    `protobuf:"zigzag32,11,opt,name=hit_wall_times,json=hitWallTimes,proto3" json:"hit_wall_times,omitempty"`                           // 撞墙次数
	CollectWreckScore    int32    `protobuf:"zigzag32,12,opt,name=collect_wreck_score,json=collectWreckScore,proto3" json:"collect_wreck_score,omitempty"`            // 收集残骸分数
	KillBonusScore       int32    `protobuf:"zigzag32,13,opt,name=kill_bonus_score,json=killBonusScore,proto3" json:"kill_bonus_score,omitempty"`                     // show 加成击杀收益分数
	UseShieldTimes       int32    `protobuf:"zigzag32,14,opt,name=use_shield_times,json=useShieldTimes,proto3" json:"use_shield_times,omitempty"`                     // 使用护盾次数
	DieTime              int32    `protobuf:"zigzag32,15,opt,name=die_time,json=dieTime,proto3" json:"die_time,omitempty"`                                            // 游戏结束前最后一次死亡时间(毫秒)
	UseSpeedShoesTimes   int32    `protobuf:"zigzag32,16,opt,name=use_speed_shoes_times,json=useSpeedShoesTimes,proto3" json:"use_speed_shoes_times,omitempty"`       // 使用加速鞋次数
	FragmentScore        int64    `protobuf:"varint,17,opt,name=fragment_score,json=fragmentScore,proto3" json:"fragment_score,omitempty"`                            // 碎片分数
	TreasureCount        int64    `protobuf:"varint,18,opt,name=treasure_count,json=treasureCount,proto3" json:"treasure_count,omitempty"`                            // 宝藏个数
}
...
func (x *KuromiPlayerScore) GetUseShieldTimes() int32 {
	if x != nil {
		return x.UseShieldTimes
	}
	return 0
...
func (x *KuromiPlayerScore) GetUseSpeedShoesTimes() int32 {
	if x != nil {
		return x.UseSpeedShoesTimes
	}
	return 0
...
func (x *KuromiPlayerScore) GetFragmentScore() int64 {
	if x != nil {
...
func (x *KuromiPlayerScore) GetTreasureCount() int64 {
	if x != nil {
...
var file_unitygame_unitygame_proto_rawDesc = []byte{
	...
	,
	...
	0x06, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x22, 0xab, 0x01, 0x0a, 0x0a, 0x43, 0x6f, 0x6d, 0x6d,
	...
	,
	...
	0x28, 0x0c, 0x52, 0x08, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x22, 0x0d, 0x0a, 0x0b,
	0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x52, 0x73, 0x70, 0x22, 0x46, 0x0a, 0x0b, 0x43,
	0x68, 0x65, 0x63, 0x6b, 0x53, 0x75, 0x6d, 0x52, 0x65, 0x71, 0x12, 0x1b, 0x0a, 0x09, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6e, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x61,
	...
	,
	...
	0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x6d, 0x6f, 0x64, 0x65, 0x56, 0x65, 0x72, 0x73, 0x69,
	...
	,
	...
	,
	...
	0x6f, 0x2f, 0x75, 0x6e, 0x69, 0x74, 0x79, 0x67, 0x61, 0x6d, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_unitygame_unitygame_proto_msgTypes = make([]protoimpl.MessageInfo, 35)
var file_unitygame_unitygame_proto_goTypes = []interface{}{
	...
	(*KuromiPlayerScore)(nil),      // 36: unitygame.KuromiPlayerScore
}
var file_unitygame_unitygame_proto_depIdxs = []int32{
	...
	36, // 10: unitygame.ReportKuromiScoreReq.score_list:type_name -> unitygame.KuromiPlayerScore
