...
import (
	match "git.17zjh.com/snake/snake_proto/matchx/match"
...
const (
	...
	SnakeOpType_ReportGoatScore      SnakeOpType = 9018
	SnakeOpType_ReportUnitygameScore SnakeOpType = 9019
...
var (
	SnakeOpType_name = map[int32]string{
		...
		9018: "ReportGoatScore",
		9019: "ReportUnitygameScore",
		9101: "PuGameStart",
		9102: "PuFrame",
		9103: "PuSignal",
		9104: "PuAbnormal",
	...
	SnakeOpType_value = map[string]int32{
		...
		"ReportGoatScore":      9018,
		"ReportUnitygameScore": 9019,
		"PuGameStart":          9101,
		"PuFrame":              9102,
		"PuSignal":             9103,
		"PuAbnormal":           9104,
...
const (
	...
	Command_CommandAITakeOverOn  Command = 6 // 开启 AI 接管，参考: https://wepie.feishu.cn/wiki/N7cUwnNoOidmMvk1k6ac08CVnFh#share-WguXdnlp3oEmAoxDhGHcgTZXncf
	Command_CommandAITakeOverOff Command = 7 // 取消 AI 接管，参考: https://wepie.feishu.cn/wiki/N7cUwnNoOidmMvk1k6ac08CVnFh#share-WguXdnlp3oEmAoxDhGHcgTZXncf
)
...
var (
	Command_name = map[int32]string{
		...
		4: "CommandExitGame",
		5: "CommandSetVoite",
		6: "CommandAITakeOverOn",
		7: "CommandAITakeOverOff",
	}
	Command_value = map[string]int32{
		...
		"CommandExitGame":      4,
		"CommandSetVoite":      5,
		"CommandAITakeOverOn":  6,
		"CommandAITakeOverOff": 7,
	}
)
...
type GameAction struct {
	...
	Num       int32          `protobuf:"varint,1,opt,name=num,proto3" json:"num,omitempty"`
	Cmd       int32          `protobuf:"varint,2,opt,name=cmd,proto3" json:"cmd,omitempty"`                              //0为移动，1复活，2中途加入，3用游戏道具，4玩家退出，5语音，6开启AI接管，7取消AI接管；如果没有某个玩家说明没发帧，按之前方向移动
...
func (x *CommandRsp) GetServerTime() int64 {
	if x != nil {
		return x.ServerTime
	}
	return 0
...
type BindReq struct {
	...
	Version        string `protobuf:"bytes,11,opt,name=version,proto3" json:"version,omitempty"`                                        // 客户端版本号
}
...
func (x *BindReq) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
type ReportScoreReq struct {
	...
	MakeWreckScore int32          `protobuf:"zigzag32,6,opt,name=make_wreck_score,json=makeWreckScore,proto3" json:"make_wreck_score,omitempty"` // 产生的残骸总分数
}
...
func (x *ReportScoreReq) GetMakeWreckScore() int32 {
	if x != nil {
		return x.MakeWreckScore
	}
	return 0
}
...
type GoatPlayerScore struct {
	...
	MaxDieTime           int64            `protobuf:"varint,20,opt,name=max_die_time,json=maxDieTime,proto3" json:"max_die_time,omitempty"`                                 // 最久死了多久（毫秒），一直维护一个最大值
}
...
func (x *GoatPlayerScore) GetMaxDieTime() int64 {
	if x != nil {
		return x.MaxDieTime
	}
	return 0
...
type ReportUnitygameScoreReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	GameMode int32  `protobuf:"varint,1,opt,name=game_mode,json=gameMode,proto3" json:"game_mode,omitempty"`
	Result   []byte `protobuf:"bytes,2,opt,name=result,proto3" json:"result,omitempty"`      // 使用 pb 进行序列化和反序列化
	Checksum int64  `protobuf:"varint,3,opt,name=checksum,proto3" json:"checksum,omitempty"` // 校验码
}

func (x *ReportUnitygameScoreReq) Reset() {
	*x = ReportUnitygameScoreReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_unitygame_unitygame_proto_msgTypes[40]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ReportUnitygameScoreReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportUnitygameScoreReq) ProtoMessage() {}

func (x *ReportUnitygameScoreReq) ProtoReflect() protoreflect.Message {
	mi := &file_unitygame_unitygame_proto_msgTypes[40]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportUnitygameScoreReq.ProtoReflect.Descriptor instead.
func (*ReportUnitygameScoreReq) Descriptor() ([]byte, []int) {
	return file_unitygame_unitygame_proto_rawDescGZIP(), []int{40}
}

func (x *ReportUnitygameScoreReq) GetGameMode() int32 {
	if x != nil {
		return x.GameMode
	}
	return 0
...
func (x *ReportUnitygameScoreReq) GetResult() []byte {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *ReportUnitygameScoreReq) GetChecksum() int64 {
	if x != nil {
		return x.Checksum
	}
	return 0
...
type ReportUnitygameScoreRsp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ReportUnitygameScoreRsp) Reset() {
	*x = ReportUnitygameScoreRsp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_unitygame_unitygame_proto_msgTypes[41]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ReportUnitygameScoreRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportUnitygameScoreRsp) ProtoMessage() {}

func (x *ReportUnitygameScoreRsp) ProtoReflect() protoreflect.Message {
	mi := &file_unitygame_unitygame_proto_msgTypes[41]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportUnitygameScoreRsp.ProtoReflect.Descriptor instead.
func (*ReportUnitygameScoreRsp) Descriptor() ([]byte, []int) {
	return file_unitygame_unitygame_proto_rawDescGZIP(), []int{41}
}
...
type ReplayGameInfo struct {
	...
	MatchInfo *match.MatchSuccessNotify `protobuf:"bytes,1,opt,name=match_info,json=matchInfo,proto3" json:"match_info,omitempty"`
	Frames    *PuFrameMsg               `protobuf:"bytes,2,opt,name=frames,proto3" json:"frames,omitempty"`   // kcp回放帧数据
	Action2   *PuAction2                `protobuf:"bytes,3,opt,name=action2,proto3" json:"action2,omitempty"` // udp回放帧数据
}

func (x *ReplayGameInfo) Reset() {
	*x = ReplayGameInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_unitygame_unitygame_proto_msgTypes[42]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ReplayGameInfo) Descriptor() ([]byte, []int) {
	return file_unitygame_unitygame_proto_rawDescGZIP(), []int{42}
}

func (x *ReplayGameInfo) GetMatchInfo() *match.MatchSuccessNotify {
	if x != nil {
		return x.MatchInfo
	}
	return nil
...
func (x *ReplayGameInfo) GetFrames() *PuFrameMsg {
	if x != nil {
		return x.Frames
	}
	return nil
...
func (x *ReplayGameInfo) GetAction2() *PuAction2 {
	if x != nil {
		return x.Action2
	}
	return nil
...
type PuAction2 struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	FrameCommandList []*FrameCommand2 `protobuf:"bytes,1,rep,name=frame_command_list,json=frameCommandList,proto3" json:"frame_command_list,omitempty"`
}

func (x *PuAction2) Reset() {
	*x = PuAction2{}
	if protoimpl.UnsafeEnabled {
		mi := &file_unitygame_unitygame_proto_msgTypes[43]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *PuAction2) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PuAction2) ProtoMessage() {}

func (x *PuAction2) ProtoReflect() protoreflect.Message {
	mi := &file_unitygame_unitygame_proto_msgTypes[43]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PuAction2.ProtoReflect.Descriptor instead.
func (*PuAction2) Descriptor() ([]byte, []int) {
	return file_unitygame_unitygame_proto_rawDescGZIP(), []int{43}
}

func (x *PuAction2) GetFrameCommandList() []*FrameCommand2 {
	if x != nil {
...
func (x *FrameCommand2) Reset() {
	*x = FrameCommand2{}
	if protoimpl.UnsafeEnabled {
		mi := &file_unitygame_unitygame_proto_msgTypes[44]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *FrameCommand2) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FrameCommand2) ProtoMessage() {}

func (x *FrameCommand2) ProtoReflect() protoreflect.Message {
	mi := &file_unitygame_unitygame_proto_msgTypes[44]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FrameCommand2.ProtoReflect.Descriptor instead.
func (*FrameCommand2) Descriptor() ([]byte, []int) {
	return file_unitygame_unitygame_proto_rawDescGZIP(), []int{44}
}

func (x *FrameCommand2) GetFrame() []byte {
	if x != nil {
		return x.Frame
	}
	return nil
...
func (x *FrameCommand2) GetCommand() string {
	if x != nil {
		return x.Command
	}
	return ""
...
var file_unitygame_unitygame_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x67, 0x61, 0x6d, 0x65, 0x1a, 0x18, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x78, 0x2f, 0x6d,
	0x61, 0x74, 0x63, 0x68, 0x2f, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x22, 0x54, 0x0a, 0x0e, 0x50, 0x75, 0x47, 0x61, 0x6d, 0x65, 0x53, 0x74, 0x61, 0x72, 0x74, 0x4d,
	...
	0x65, 0x12, 0x23, 0x0a, 0x0d, 0x74, 0x75, 0x72, 0x6e, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76,
	0x61, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x74, 0x75, 0x72, 0x6e, 0x49, 0x6e,
	0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x22, 0x4d, 0x0a, 0x0b, 0x50, 0x75, 0x53, 0x69, 0x67, 0x6e,
	0x61, 0x6c, 0x4d, 0x73, 0x67, 0x12, 0x10, 0x0a, 0x03, 0x6e, 0x75, 0x6d, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x03, 0x6e, 0x75, 0x6d, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x69, 0x67, 0x6e, 0x61,
	...
	,
	...
	0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x04, 0x61, 0x74, 0x74, 0x72, 0x12, 0x1d, 0x0a,
	0x0a, 0x6d, 0x6f, 0x64, 0x65, 0x5f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x09, 0x6d, 0x6f, 0x64, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x22, 0xf2, 0x02, 0x0a,
	0x0d, 0x75, 0x73, 0x65, 0x72, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x12, 0x10,
	...
	,
	...
	,
	...
	0x0b, 0x6d, 0x6f, 0x64, 0x65, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x1d, 0x0a, 0x0a,
	0x74, 0x69, 0x6d, 0x65, 0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x70,
	...
	0x52, 0x08, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x12, 0x28, 0x0a, 0x10, 0x6d, 0x61,
	0x78, 0x5f, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x0a,
	...
	,
	...
	0x69, 0x6d, 0x65, 0x73, 0x18, 0x11, 0x20, 0x01, 0x28, 0x11, 0x52, 0x0c, 0x68, 0x69, 0x74, 0x57,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x61, 0x64, 0x64, 0x5f, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x0b, 0x61, 0x64, 0x64, 0x50, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x22,
	0x6a, 0x0a, 0x17, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x55, 0x6e, 0x69, 0x74, 0x79, 0x67, 0x61,
	0x6d, 0x65, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x52, 0x65, 0x71, 0x12, 0x1b, 0x0a, 0x09, 0x67, 0x61,
	0x6d, 0x65, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x67,
	0x61, 0x6d, 0x65, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c,
	...
	0x03, 0x52, 0x08, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x22, 0x19, 0x0a, 0x17, 0x52,
	0x65, 0x70, 0x6f, 0x72, 0x74, 0x55, 0x6e, 0x69, 0x74, 0x79, 0x67, 0x61, 0x6d, 0x65, 0x53, 0x63,
	0x6f, 0x72, 0x65, 0x52, 0x73, 0x70, 0x22, 0xa9, 0x01, 0x0a, 0x0e, 0x52, 0x65, 0x70, 0x6c, 0x61,
	0x79, 0x47, 0x61, 0x6d, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x38, 0x0a, 0x0a, 0x6d, 0x61, 0x74,
	0x63, 0x68, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e,
	...
	,
...
var file_unitygame_unitygame_proto_msgTypes = make([]protoimpl.MessageInfo, 45)
var file_unitygame_unitygame_proto_goTypes = []interface{}{
	...
	(*ReportUnitygameScoreReq)(nil),  // 42: unitygame.ReportUnitygameScoreReq
	(*ReportUnitygameScoreRsp)(nil),  // 43: unitygame.ReportUnitygameScoreRsp
	(*ReplayGameInfo)(nil),           // 44: unitygame.ReplayGameInfo
	(*PuAction2)(nil),                // 45: unitygame.PuAction2
	(*FrameCommand2)(nil),            // 46: unitygame.FrameCommand2
	(*match.MatchSuccessNotify)(nil), // 47: match.MatchSuccessNotify
}
var file_unitygame_unitygame_proto_depIdxs = []int32{
	...
	47, // 15: unitygame.ReplayGameInfo.match_info:type_name -> match.MatchSuccessNotify
	7,  // 16: unitygame.ReplayGameInfo.frames:type_name -> unitygame.PuFrameMsg
	45, // 17: unitygame.ReplayGameInfo.action2:type_name -> unitygame.PuAction2
	46, // 18: unitygame.PuAction2.frame_command_list:type_name -> unitygame.FrameCommand2
...
func file_unitygame_unitygame_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_unitygame_unitygame_proto_msgTypes[40].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReportUnitygameScoreReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_unitygame_unitygame_proto_msgTypes[41].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReportUnitygameScoreRsp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_unitygame_unitygame_proto_msgTypes[42].Exporter = func(v interface{}, i int) interface{} {
		...
		file_unitygame_unitygame_proto_msgTypes[43].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PuAction2); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_unitygame_unitygame_proto_msgTypes[44].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FrameCommand2); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
