...
func (c *matchServerClient) EndRound(ctx context.Context, in *EndRoundReq, opts ...grpc.CallOption) (*EndRoundRsp, error) {
	out := new(EndRoundRsp)
	err := c.cc.Invoke(ctx, "/fallguys.MatchServer/EndRound", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *matchServerClient) UploadMetric(ctx context.Context, opts ...grpc.CallOption) (MatchServer_UploadMetricClient, error) {
	stream, err := c.cc.NewStream(ctx, &MatchServer_ServiceDesc.Streams[1], "/fallguys.MatchServer/UploadMetric", opts...)
	if err != nil {
		return nil, err
	}
...
func _MatchServer_EndRound_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fallguys.MatchServer/EndRound",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
