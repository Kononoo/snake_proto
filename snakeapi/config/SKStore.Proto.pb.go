...
type GameMsg struct {
	...
	ImgUrls  int64 `protobuf:"varint,1,opt,name=img_urls,json=imgUrls,proto3" json:"img_urls,omitempty"`
	TurnTime int64 `protobuf:"varint,2,opt,name=turn_time,json=turnTime,proto3" json:"turn_time,omitempty"`
}
...
func (x *GameMsg) GetImgUrls() int64 {
	if x != nil {
		return x.ImgUrls
	}
	return 0
...
var file_snakeapi_config_SKStore_Proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x69, 0x6d, 0x67, 0x55, 0x72, 0x6c, 0x73, 0x12, 0x1b, 0x0a,
	0x09, 0x74, 0x75, 0x72, 0x6e, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03,
