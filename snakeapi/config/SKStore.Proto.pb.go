...
type HomepageDecorateInfo struct {
	...
	UnityAnimKey    int32  `protobuf:"varint,6,opt,name=unity_anim_key,json=unityAnimKey,proto3" json:"unity_anim_key,omitempty"`
}
...
func (x *HomepageDecorateInfo) GetUnityAnimKey() int32 {
	if x != nil {
		return x.UnityAnimKey
	}
	return 0
...
var file_snakeapi_config_SKStore_Proto_rawDesc = []byte{
	...
	0x79, 0x5f, 0x61, 0x6e, 0x69, 0x6d, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05,
