...
type RewardInfo struct {
	...
	WorthLevel    int32      `protobuf:"varint,9,opt,name=worth_level,json=worthLevel,proto3" json:"worth_level,omitempty"` //稀有度等级，从 1 开始。0 的话默认为 C 等级
	MarkId        int32      `protobuf:"varint,10,opt,name=mark_id,json=markId,proto3" json:"mark_id,omitempty"`            //0: 忽略 1: 豪华版通行证加成 2: 回归加成 3: 师徒加成
	Convert       *Convert   `protobuf:"bytes,11,opt,name=convert,proto3" json:"convert,omitempty"`                         //奖励折算，没有折算则为空
	Probability   int32      `protobuf:"varint,12,opt,name=probability,proto3" json:"probability,omitempty"`
	UseInfo       string     `protobuf:"bytes,13,opt,name=use_info,json=useInfo,proto3" json:"use_info,omitempty"`
	ConvertDetail []*Convert `protobuf:"bytes,14,rep,name=convert_detail,json=convertDetail,proto3" json:"convert_detail,omitempty"`
}
...
func (x *RewardInfo) GetConvert() *Convert {
	if x != nil {
		return x.Convert
	}
	return nil
...
func (x *RewardInfo) GetConvertDetail() []*Convert {
	if x != nil {
		return x.ConvertDetail
	}
	return nil
...
var file_snakeapi_config_SKStore_Proto_rawDesc = []byte{
	...
	0x73, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0xbc, 0x03, 0x0a, 0x0a,
	...
	0x6d, 0x61, 0x72, 0x6b, 0x49, 0x64, 0x12, 0x33, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x76, 0x65, 0x72,
	0x74, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x53, 0x6e, 0x61, 0x6b, 0x65, 0x4d,
	0x61, 0x69, 0x6e, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x43, 0x6f, 0x6e, 0x76, 0x65,
	...
	0x07, 0x75, 0x73, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x40, 0x0a, 0x0e, 0x63, 0x6f, 0x6e, 0x76,
	...
	0x66, 0x69, 0x67, 0x2e, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x74, 0x52, 0x0d, 0x63, 0x6f, 0x6e,
	0x76, 0x65, 0x72, 0x74, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x22, 0x48, 0x0a, 0x07, 0x43, 0x6f,
	...
	0x69, 0x6e, 0x49, 0x64, 0x2a, 0xff, 0x08, 0x0a, 0x0a, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x54,
...
var file_snakeapi_config_SKStore_Proto_goTypes = []interface{}{
	...
	(*Convert)(nil),                    // 97: SnakeMain.Config.Convert
...
var file_snakeapi_config_SKStore_Proto_depIdxs = []int32{
	...
	97,  // 109: SnakeMain.Config.RewardInfo.convert:type_name -> SnakeMain.Config.Convert
	97,  // 110: SnakeMain.Config.RewardInfo.convert_detail:type_name -> SnakeMain.Config.Convert
