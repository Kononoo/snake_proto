...
type ChestRewardInfo struct {
	...
	UnShowGlobalLimit  bool          `protobuf:"varint,25,opt,name=un_show_global_limit,json=unShowGlobalLimit,proto3" json:"un_show_global_limit,omitempty"`  // 是否不展示全服数量上限（默认展示）
}
...
func (x *ChestRewardInfo) GetUnShowGlobalLimit() bool {
	if x != nil {
...
var file_snakeapi_config_SKStore_Proto_rawDesc = []byte{
	...
	0x6f, 0x62, 0x61, 0x6c, 0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x18, 0x19, 0x20, 0x01, 0x28, 0x08,
