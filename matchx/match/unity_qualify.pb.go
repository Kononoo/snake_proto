...
type UnityQualifyUploadAttr struct {
	...
	IsUnityGame     bool         `protobuf:"varint,7,opt,name=is_unity_game,json=isUnityGame,proto3" json:"is_unity_game,omitempty"` // 游戏内是否使用unity
}
...
func (x *UnityQualifyUploadAttr) GetIsUnityGame() bool {
	if x != nil {
		return x.IsUnityGame
	}
	return false
}
...
type UnityQualifyMatchSuccessNotify struct {
	...
	AiConfigVersion   int64   `protobuf:"varint,4,opt,name=ai_config_version,json=aiConfigVersion,proto3" json:"ai_config_version,omitempty"`       // AI 行为配置版本
	IsUnityGame       bool    `protobuf:"varint,5,opt,name=is_unity_game,json=isUnityGame,proto3" json:"is_unity_game,omitempty"`                   // 游戏内是否使用unity
	UseNativeNetwork  bool    `protobuf:"varint,6,opt,name=use_native_network,json=useNativeNetwork,proto3" json:"use_native_network,omitempty"`    // 是否使用原生网络
}
...
func (x *UnityQualifyMatchSuccessNotify) GetAiConfigVersion() int64 {
	if x != nil {
...
func (x *UnityQualifyMatchSuccessNotify) GetIsUnityGame() bool {
	if x != nil {
		return x.IsUnityGame
	}
	return false
...
func (x *UnityQualifyMatchSuccessNotify) GetUseNativeNetwork() bool {
	if x != nil {
		return x.UseNativeNetwork
	}
	return false
}
...
var file_matchx_match_unity_qualify_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x9c, 0x02, 0x0a, 0x16, 0x55, 0x6e, 0x69, 0x74, 0x79, 0x51, 0x75, 0x61,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x70, 0x72, 0x6f, 0x70, 0x49, 0x64, 0x12, 0x22,
	0x0a, 0x0d, 0x69, 0x73, 0x5f, 0x75, 0x6e, 0x69, 0x74, 0x79, 0x5f, 0x67, 0x61, 0x6d, 0x65, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x69, 0x73, 0x55, 0x6e, 0x69, 0x74, 0x79, 0x47, 0x61,
	0x6d, 0x65, 0x22, 0x17, 0x0a, 0x15, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x6f, 0x6f, 0x6d,
	0x53, 0x63, 0x6f, 0x72, 0x65, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x22, 0x40, 0x0a, 0x09, 0x53,
	0x6b, 0x69, 0x6e, 0x53, 0x6b, 0x69, 0x6c, 0x6c, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x6b, 0x69, 0x6c,
	...
	,
	...
	,
...
var file_matchx_match_unity_qualify_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_matchx_match_unity_qualify_proto_goTypes = []interface{}{
	...
	(*UploadAttrReq)(nil),                     // 8: match.UploadAttrReq
}
var file_matchx_match_unity_qualify_proto_depIdxs = []int32{
	...
	8, // 1: match.UnityQualifyJoinRoom.attr:type_name -> match.UploadAttrReq
