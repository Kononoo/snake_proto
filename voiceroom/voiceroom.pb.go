...
var file_voiceroom_voiceroom_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x6f, 0x70, 0x74, 0x2a, 0xed, 0x05, 0x0a, 0x0b, 0x56, 0x6f,
	...
	0x69, 0x73, 0x74, 0x10, 0x1c, 0x12, 0x0d, 0x0a, 0x09, 0x49, 0x6e, 0x6e, 0x65, 0x72, 0x43, 0x61,
	...
	0x61, 0x63, 0x6b, 0x4c, 0x69, 0x73, 0x74, 0x10, 0x75, 0x2a, 0x49, 0x0a, 0x14, 0x76, 0x6f, 0x69,
	...
	0x69, 0x66, 0x74, 0x10, 0x02, 0x42, 0x35, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x2e, 0x31, 0x37, 0x7a,
...
var file_voiceroom_voiceroom_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_voiceroom_voiceroom_proto_msgTypes = make([]protoimpl.MessageInfo, 88)
var file_voiceroom_voiceroom_proto_goTypes = []interface{}{
	...
	(*RoomInfo)(nil),             // 7: voiceroom.roomInfo
	(*VoiceRoomMusicInfo)(nil),   // 8: voiceroom.voiceRoomMusicInfo
	(*RoomSetting)(nil),          // 9: voiceroom.roomSetting
	(*SeatInfo)(nil),             // 10: voiceroom.seatInfo
	(*PkInfo)(nil),               // 11: voiceroom.pkInfo
	(*Location)(nil),             // 12: voiceroom.location
	(*NewRoomReq)(nil),           // 13: voiceroom.NewRoomReq
	(*NewRoomRsp)(nil),           // 14: voiceroom.NewRoomRsp
	(*MyPreRoomReq)(nil),         // 15: voiceroom.MyPreRoomReq
	(*MyPreRoomRsp)(nil),         // 16: voiceroom.MyPreRoomRsp
	(*EnterRoomReq)(nil),         // 17: voiceroom.EnterRoomReq
	(*EnterRoomRsp)(nil),         // 18: voiceroom.EnterRoomRsp
	(*UpdateSettingReq)(nil),     // 19: voiceroom.UpdateSettingReq
	(*UpdateSettingRsp)(nil),     // 20: voiceroom.UpdateSettingRsp
	(*PuUpdateSettingMsg)(nil),   // 21: voiceroom.PuUpdateSettingMsg
	(*ExitRoomReq)(nil),          // 22: voiceroom.ExitRoomReq
	(*ExitRoomRsp)(nil),          // 23: voiceroom.ExitRoomRsp
	(*GetMemberListReq)(nil),     // 24: voiceroom.GetMemberListReq
	(*MemberListItem)(nil),       // 25: voiceroom.MemberListItem
	(*GetMemberListRsp)(nil),     // 26: voiceroom.GetMemberListRsp
	(*LotteryReq)(nil),           // 27: voiceroom.LotteryReq
	(*LotteryRsp)(nil),           // 28: voiceroom.LotteryRsp
	(*PuLotteryResultMsg)(nil),   // 29: voiceroom.PuLotteryResultMsg
	(*InnerCallReq)(nil),         // 30: voiceroom.InnerCallReq
	(*InnerCallRsp)(nil),         // 31: voiceroom.InnerCallRsp
	(*AdminRoomInfo)(nil),        // 32: voiceroom.adminRoomInfo
	(*PlayerChangeItem)(nil),     // 33: voiceroom.playerChangeItem
	(*PuPlayerChangeMsg)(nil),    // 34: voiceroom.PuPlayerChangeMsg
	(*PuSeatChangeMsg)(nil),      // 35: voiceroom.PuSeatChangeMsg
	(*LockSeatReq)(nil),          // 36: voiceroom.LockSeatReq
	(*LockSeatRsp)(nil),          // 37: voiceroom.LockSeatRsp
	(*PlayerManagerReq)(nil),     // 38: voiceroom.PlayerManagerReq
	(*PlayerManagerRsp)(nil),     // 39: voiceroom.PlayerManagerRsp
	(*SeatInviteReq)(nil),        // 40: voiceroom.SeatInviteReq
	(*SeatInviteRsp)(nil),        // 41: voiceroom.SeatInviteRsp
	(*PuSeatInviteMsg)(nil),      // 42: voiceroom.PuSeatInviteMsg
	(*HandleSeatInviteReq)(nil),  // 43: voiceroom.HandleSeatInviteReq
	(*HandleSeatInviteRsp)(nil),  // 44: voiceroom.HandleSeatInviteRsp
	(*UseSeatReq)(nil),           // 45: voiceroom.UseSeatReq
	(*UseSeatRsp)(nil),           // 46: voiceroom.UseSeatRsp
	(*PuRoomCloseMsg)(nil),       // 47: voiceroom.PuRoomCloseMsg
	(*MicOptReq)(nil),            // 48: voiceroom.MicOptReq
	(*MicOptRsp)(nil),            // 49: voiceroom.MicOptRsp
	(*SendRedPackReq)(nil),       // 50: voiceroom.SendRedPackReq
	(*SendRedPackRsp)(nil),       // 51: voiceroom.SendRedPackRsp
	(*PuRedPackMsg)(nil),         // 52: voiceroom.PuRedPackMsg
	(*UserGeoInfo)(nil),          // 53: voiceroom.userGeoInfo
	(*GetNearbyReq)(nil),         // 54: voiceroom.GetNearbyReq
	(*GetNearbyRsp)(nil),         // 55: voiceroom.GetNearbyRsp
	(*GetBlackListReq)(nil),      // 56: voiceroom.GetBlackListReq
	(*GetBlackListRsp)(nil),      // 57: voiceroom.GetBlackListRsp
	(*GetRoomListReq)(nil),       // 58: voiceroom.GetRoomListReq
	(*PuRoomBlackUpdateMsg)(nil), // 59: voiceroom.PuRoomBlackUpdateMsg
	(*RoomListItem)(nil),         // 60: voiceroom.RoomListItem
	(*GetRoomListRsp)(nil),       // 61: voiceroom.GetRoomListRsp
	(*SearchRoomReq)(nil),        // 62: voiceroom.SearchRoomReq
	(*TopShowMember)(nil),        // 63: voiceroom.topShowMember
	(*SearchRoomRsp)(nil),        // 64: voiceroom.SearchRoomRsp
	(*StartPkReq)(nil),           // 65: voiceroom.StartPkReq
	(*StartPkRsp)(nil),           // 66: voiceroom.StartPkRsp
	(*PuStartPkMsg)(nil),         // 67: voiceroom.PuStartPkMsg
	(*GetPkInfoReq)(nil),         // 68: voiceroom.GetPkInfoReq
	(*GetPkInfoRsp)(nil),         // 69: voiceroom.GetPkInfoRsp
	(*PuPkResultMsg)(nil),        // 70: voiceroom.PuPkResultMsg
	(*RoomChatMsg)(nil),          // 71: voiceroom.RoomChatMsg
	(*PuRoomChatMsg)(nil),        // 72: voiceroom.PuRoomChatMsg
	(*PkVoteReq)(nil),            // 73: voiceroom.PkVoteReq
	(*PkVoteRsp)(nil),            // 74: voiceroom.PkVoteRsp
	(*PkSendGiftReq)(nil),        // 75: voiceroom.PkSendGiftReq
	(*PkSendGiftRsp)(nil),        // 76: voiceroom.PkSendGiftRsp
	(*SendChatReq)(nil),          // 77: voiceroom.SendChatReq
	(*SendChatRsp)(nil),          // 78: voiceroom.SendChatRsp
	(*SendGiftReq)(nil),          // 79: voiceroom.SendGiftReq
	(*SendGiftInfo)(nil),         // 80: voiceroom.SendGiftInfo
	(*SendGiftRspInfo)(nil),      // 81: voiceroom.SendGiftRspInfo
	(*SendGiftRsp)(nil),          // 82: voiceroom.SendGiftRsp
	(*PuSendGiftMsg)(nil),        // 83: voiceroom.PuSendGiftMsg
	(*SendEmojiReq)(nil),         // 84: voiceroom.SendEmojiReq
	(*SendEmojiRsp)(nil),         // 85: voiceroom.SendEmojiRsp
	(*PuSendEmojiMsg)(nil),       // 86: voiceroom.PuSendEmojiMsg
	(*SeatKickReq)(nil),          // 87: voiceroom.SeatKickReq
	(*SeatKickRsp)(nil),          // 88: voiceroom.SeatKickRsp
	(*PuSeatKickMsg)(nil),        // 89: voiceroom.PuSeatKickMsg
	(*RoomInviteReq)(nil),        // 90: voiceroom.RoomInviteReq
	(*RoomInviteRsp)(nil),        // 91: voiceroom.RoomInviteRsp
	(*PuRoomInviteMsg)(nil),      // 92: voiceroom.PuRoomInviteMsg
	(*PuPlayMusicMsg)(nil),       // 93: voiceroom.PuPlayMusicMsg
	(*PuBanChatMsg)(nil),         // 94: voiceroom.PuBanChatMsg
}
var file_voiceroom_voiceroom_proto_depIdxs = []int32{
	9,  // 0: voiceroom.roomInfo.setting:type_name -> voiceroom.roomSetting
	10, // 1: voiceroom.roomInfo.seatList:type_name -> voiceroom.seatInfo
	11, // 2: voiceroom.roomInfo.pk:type_name -> voiceroom.pkInfo
	8,  // 3: voiceroom.roomInfo.music:type_name -> voiceroom.voiceRoomMusicInfo
	...
	9,  // 6: voiceroom.NewRoomReq.param:type_name -> voiceroom.roomSetting
	12, // 7: voiceroom.NewRoomReq.pos:type_name -> voiceroom.location
	7,  // 8: voiceroom.NewRoomRsp.room:type_name -> voiceroom.roomInfo
	9,  // 9: voiceroom.MyPreRoomRsp.setting:type_name -> voiceroom.roomSetting
	12, // 10: voiceroom.EnterRoomReq.pos:type_name -> voiceroom.location
	7,  // 11: voiceroom.EnterRoomRsp.room:type_name -> voiceroom.roomInfo
	9,  // 12: voiceroom.UpdateSettingReq.setting:type_name -> voiceroom.roomSetting
	9,  // 13: voiceroom.PuUpdateSettingMsg.setting:type_name -> voiceroom.roomSetting
	25, // 14: voiceroom.GetMemberListRsp.members:type_name -> voiceroom.MemberListItem
	...
	32, // 17: voiceroom.InnerCallRsp.room_info:type_name -> voiceroom.adminRoomInfo
	10, // 18: voiceroom.PuSeatChangeMsg.seatList:type_name -> voiceroom.seatInfo
	4,  // 19: voiceroom.PlayerManagerReq.opt:type_name -> voiceroom.playerManagerType
	12, // 20: voiceroom.GetNearbyReq.pos:type_name -> voiceroom.location
	53, // 21: voiceroom.GetNearbyRsp.users:type_name -> voiceroom.userGeoInfo
	5,  // 22: voiceroom.GetBlackListReq.black_type:type_name -> voiceroom.RoomBlackType
	12, // 23: voiceroom.GetRoomListReq.pos:type_name -> voiceroom.location
	5,  // 24: voiceroom.PuRoomBlackUpdateMsg.black_type:type_name -> voiceroom.RoomBlackType
	60, // 25: voiceroom.GetRoomListRsp.rooms:type_name -> voiceroom.RoomListItem
	12, // 26: voiceroom.SearchRoomReq.pos:type_name -> voiceroom.location
	63, // 27: voiceroom.SearchRoomRsp.top_member:type_name -> voiceroom.topShowMember
	6,  // 28: voiceroom.StartPkReq.type:type_name -> voiceroom.PkType
	11, // 29: voiceroom.StartPkRsp.pk_info:type_name -> voiceroom.pkInfo
	11, // 30: voiceroom.PuStartPkMsg.pk_info:type_name -> voiceroom.pkInfo
	11, // 31: voiceroom.GetPkInfoRsp.pk_info:type_name -> voiceroom.pkInfo
	71, // 32: voiceroom.PuRoomChatMsg.messages:type_name -> voiceroom.RoomChatMsg
	11, // 33: voiceroom.PkVoteRsp.pk_info:type_name -> voiceroom.pkInfo
	80, // 34: voiceroom.PkSendGiftReq.info:type_name -> voiceroom.SendGiftInfo
	11, // 35: voiceroom.PkSendGiftRsp.pk_info:type_name -> voiceroom.pkInfo
	81, // 36: voiceroom.PkSendGiftRsp.gift_info:type_name -> voiceroom.SendGiftRspInfo
	80, // 37: voiceroom.SendGiftReq.info:type_name -> voiceroom.SendGiftInfo
	81, // 38: voiceroom.SendGiftRsp.info:type_name -> voiceroom.SendGiftRspInfo
	8,  // 39: voiceroom.PuPlayMusicMsg.music:type_name -> voiceroom.voiceRoomMusicInfo
