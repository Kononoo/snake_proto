...
type PuPlayMusicMsg struct {
	...
	Title  string      `protobuf:"bytes,2,opt,name=title,proto3" json:"title,omitempty"`
	Artist string      `protobuf:"bytes,3,opt,name=artist,proto3" json:"artist,omitempty"`
	Status MusicStatus `protobuf:"varint,5,opt,name=status,proto3,enum=voiceroom.MusicStatus" json:"status,omitempty"`
}
...
func (x *PuPlayMusicMsg) GetStatus() MusicStatus {
	if x != nil {
		return x.Status
	}
...
var file_voiceroom_voiceroom_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x72, 0x69, 0x64, 0x22, 0x7e, 0x0a, 0x0e, 0x50, 0x75, 0x50, 0x6c, 0x61, 0x79, 0x4d,
	...
	0x72, 0x74, 0x69, 0x73, 0x74, 0x12, 0x2e, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x16, 0x2e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x72, 0x6f, 0x6f,
	0x6d, 0x2e, 0x6d, 0x75, 0x73, 0x69, 0x63, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x2a, 0xbb, 0x05, 0x0a, 0x0b, 0x56, 0x6f, 0x69, 0x63, 0x65, 0x4f,
	...
	0x63, 0x10, 0x73, 0x2a, 0x34, 0x0a, 0x0b, 0x6c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x54, 0x79,
	...
	0x41, 0x6c, 0x6c, 0x55, 0x73, 0x65, 0x72, 0x10, 0x02, 0x2a, 0x8c, 0x01, 0x0a, 0x0d, 0x69, 0x6e,
	...
	0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x10, 0x05, 0x2a, 0x7d, 0x0a, 0x11, 0x70, 0x6c, 0x61, 0x79,
	...
	0x10, 0x02, 0x2a, 0x40, 0x0a, 0x0b, 0x6d, 0x75, 0x73, 0x69, 0x63, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	0x73, 0x65, 0x10, 0x03, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x2e, 0x31, 0x37, 0x7a, 0x6a,
...
var file_voiceroom_voiceroom_proto_goTypes = []interface{}{
	...
	(MusicStatus)(0),            // 5: voiceroom.musicStatus
	(*RoomInfo)(nil),            // 6: voiceroom.roomInfo
	(*MusicInfo)(nil),           // 7: voiceroom.musicInfo
	...
	(*SearchRoomRsp)(nil),       // 59: voiceroom.SearchRoomRsp
	(*StartPkReq)(nil),          // 60: voiceroom.StartPkReq
	(*StartPkRsp)(nil),          // 61: voiceroom.StartPkRsp
	(*PuStartPkMsg)(nil),        // 62: voiceroom.PuStartPkMsg
	(*GetPkInfoReq)(nil),        // 63: voiceroom.GetPkInfoReq
	(*GetPkInfoRsp)(nil),        // 64: voiceroom.GetPkInfoRsp
	(*PuPkResultMsg)(nil),       // 65: voiceroom.PuPkResultMsg
	(*RoomChatMsg)(nil),         // 66: voiceroom.RoomChatMsg
	(*PuRoomChatMsg)(nil),       // 67: voiceroom.PuRoomChatMsg
	(*PkVoteReq)(nil),           // 68: voiceroom.PkVoteReq
	(*PkVoteRsp)(nil),           // 69: voiceroom.PkVoteRsp
	(*PkSendGiftReq)(nil),       // 70: voiceroom.PkSendGiftReq
	(*PkSendGiftRsp)(nil),       // 71: voiceroom.PkSendGiftRsp
	(*SendChatReq)(nil),         // 72: voiceroom.SendChatReq
	(*SendChatRsp)(nil),         // 73: voiceroom.SendChatRsp
	(*SendGiftReq)(nil),         // 74: voiceroom.SendGiftReq
	(*SendGiftRsp)(nil),         // 75: voiceroom.SendGiftRsp
	(*PuSendGiftMsg)(nil),       // 76: voiceroom.PuSendGiftMsg
	(*SendEmojiReq)(nil),        // 77: voiceroom.SendEmojiReq
	(*SendEmojiRsp)(nil),        // 78: voiceroom.SendEmojiRsp
	(*PuSendEmojiMsg)(nil),      // 79: voiceroom.PuSendEmojiMsg
	(*SeatKickReq)(nil),         // 80: voiceroom.SeatKickReq
	(*SeatKickRsp)(nil),         // 81: voiceroom.SeatKickRsp
	(*PuSeatKickMsg)(nil),       // 82: voiceroom.PuSeatKickMsg
	(*RoomInviteReq)(nil),       // 83: voiceroom.RoomInviteReq
	(*RoomInviteRsp)(nil),       // 84: voiceroom.RoomInviteRsp
	(*PuRoomInviteMsg)(nil),     // 85: voiceroom.PuRoomInviteMsg
	(*PuPlayMusicMsg)(nil),      // 86: voiceroom.PuPlayMusicMsg
}
var file_voiceroom_voiceroom_proto_depIdxs = []int32{
	...
	7,  // 3: voiceroom.roomInfo.music:type_name -> voiceroom.musicInfo
	4,  // 4: voiceroom.pkInfo.type:type_name -> voiceroom.PkType
	8,  // 5: voiceroom.NewRoomReq.param:type_name -> voiceroom.roomSetting
	11, // 6: voiceroom.NewRoomReq.pos:type_name -> voiceroom.location
	6,  // 7: voiceroom.NewRoomRsp.room:type_name -> voiceroom.roomInfo
	8,  // 8: voiceroom.MyPreRoomRsp.setting:type_name -> voiceroom.roomSetting
	11, // 9: voiceroom.EnterRoomReq.pos:type_name -> voiceroom.location
	6,  // 10: voiceroom.EnterRoomRsp.room:type_name -> voiceroom.roomInfo
	8,  // 11: voiceroom.UpdateSettingReq.setting:type_name -> voiceroom.roomSetting
	8,  // 12: voiceroom.PuUpdateSettingMsg.setting:type_name -> voiceroom.roomSetting
	24, // 13: voiceroom.GetMemberListRsp.members:type_name -> voiceroom.MemberListItem
	...
	31, // 16: voiceroom.InnerCallRsp.room_info:type_name -> voiceroom.adminRoomInfo
	32, // 17: voiceroom.PuPlayerChangeMsg.change_list:type_name -> voiceroom.playerChangeItem
	...
	56, // 25: voiceroom.SearchRoomRsp.rooms:type_name -> voiceroom.RoomListItem
	...
	66, // 30: voiceroom.PuRoomChatMsg.messages:type_name -> voiceroom.RoomChatMsg
	10, // 31: voiceroom.PkVoteRsp.pk_info:type_name -> voiceroom.pkInfo
	10, // 32: voiceroom.PkSendGiftRsp.pk_info:type_name -> voiceroom.pkInfo
	5,  // 33: voiceroom.PuPlayMusicMsg.status:type_name -> voiceroom.musicStatus
