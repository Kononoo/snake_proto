...
type Section struct {
	...
	ComponentType int64  `protobuf:"varint,1,opt,name=component_type,json=componentType,proto3" json:"component_type,omitempty"` // 组件类型
	Id            int64  `protobuf:"varint,3,opt,name=id,proto3" json:"id,omitempty"`                                            // 样式id
	StyleImg      string `protobuf:"bytes,4,opt,name=style_img,json=styleImg,proto3" json:"style_img,omitempty"`                 // 样式名
	StyleName     string `protobuf:"bytes,5,opt,name=style_name,json=styleName,proto3" json:"style_name,omitempty"`              // 样式图
	WorthLevel    string `protobuf:"bytes,6,opt,name=worth_level,json=worthLevel,proto3" json:"worth_level,omitempty"`
	Default       int64  `protobuf:"varint,7,opt,name=default,proto3" json:"default,omitempty"` // 是否为默认样式
}
...
func (x *Section) GetComponentType() int64 {
	if x != nil {
...
func (x *Section) GetStyleImg() string {
	if x != nil {
		return x.StyleImg
	}
	return ""
...
func (x *Section) GetWorthLevel() string {
	if x != nil {
		return x.WorthLevel
	}
	return ""
...
func (x *Section) GetDefault() int64 {
	if x != nil {
		return x.Default
	}
	return 0
...
type GetInfoRsp struct {
	...
	PendingSkin   *Skin              `protobuf:"bytes,7,opt,name=pending_skin,json=pendingSkin,proto3" json:"pending_skin,omitempty"`               // 待保存的皮肤id
	LastSkin      *Skin              `protobuf:"bytes,8,opt,name=last_skin,json=lastSkin,proto3" json:"last_skin,omitempty"`                        // 上次幻化的皮肤id
...
type Skin struct {
	...
	Sections   []*Section `protobuf:"bytes,4,rep,name=sections,proto3" json:"sections,omitempty"`                        // 样式列表，默认样式不传
	ShowWorth  int64      `protobuf:"varint,5,opt,name=show_worth,json=showWorth,proto3" json:"show_worth,omitempty"`    // show值
	WorthLevel int64      `protobuf:"varint,6,opt,name=worth_level,json=worthLevel,proto3" json:"worth_level,omitempty"` // 等级
}
...
func (x *Skin) GetSections() []*Section {
	if x != nil {
		return x.Sections
	}
	return nil
...
func (x *Skin) GetShowWorth() int64 {
	if x != nil {
		return x.ShowWorth
	}
	return 0
...
func (x *Skin) GetWorthLevel() int64 {
	if x != nil {
		return x.WorthLevel
	}
	return 0
...
type RefreshSkinRsp struct {
	...
	Coin int64 `protobuf:"varint,4,opt,name=coin,proto3" json:"coin,omitempty"` // 更新幻化币数量
}
...
type RestoreSkinRsp struct {
	...
	SkinId int64 `protobuf:"varint,1,opt,name=skin_id,json=skinId,proto3" json:"skin_id,omitempty"` //复原后的皮肤id
	Coin   int64 `protobuf:"varint,4,opt,name=coin,proto3" json:"coin,omitempty"`                   // 更新幻化币数量
}
...
func (x *RestoreSkinRsp) GetSkinId() int64 {
	if x != nil {
		return x.SkinId
	}
	return 0
...
func (*GetInfoRsp_DescItem) Descriptor() ([]byte, []int) {
	return file_activity_magic_skin_magic_skin_proto_rawDescGZIP(), []int{2, 0}
}
...
type GetInfoRsp_Config struct {
	...
	MagicSkinId       int64                  `protobuf:"varint,6,opt,name=magic_skin_id,json=magicSkinId,proto3" json:"magic_skin_id,omitempty"`                                                                                                 // 本期活动指定的幻化皮肤id
	MagicSkinJumpLink string                 `protobuf:"bytes,7,opt,name=magic_skin_jump_link,json=magicSkinJumpLink,proto3" json:"magic_skin_jump_link,omitempty"`                                                                              // 获取幻化皮肤的活动跳转链接
	BaseCostCoin      int64                  `protobuf:"varint,8,opt,name=base_cost_coin,json=baseCostCoin,proto3" json:"base_cost_coin,omitempty"`                                                                                              // 基础的消耗幻化币数量
	ExchangeRate      int64                  `protobuf:"varint,9,opt,name=exchange_rate,json=exchangeRate,proto3" json:"exchange_rate,omitempty"`                                                                                                // 1幻化币价值多少苹果
	ExtraCostCoin     map[int64]int64        `protobuf:"bytes,10,rep,name=extra_cost_coin,json=extraCostCoin,proto3" json:"extra_cost_coin,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` // {锁定属性的个数:额外消耗的幻化币数量}
	UnlockSection     map[int64]int64        `protobuf:"bytes,11,rep,name=unlock_section,json=unlockSection,proto3" json:"unlock_section,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`   // {组件类型：激活所需幻化值}
	SaveSkinLimit     int64                  `protobuf:"varint,12,opt,name=save_skin_limit,json=saveSkinLimit,proto3" json:"save_skin_limit,omitempty"`                                                                                          // 保存藏品次数限制
	SaveCostCrystal   int64                  `protobuf:"varint,13,opt,name=save_cost_crystal,json=saveCostCrystal,proto3" json:"save_cost_crystal,omitempty"`                                                                                    // 每次保存藏品消耗的水晶数量
	CoinPackLink      string                 `protobuf:"bytes,14,opt,name=coin_pack_link,json=coinPackLink,proto3" json:"coin_pack_link,omitempty"`                                                                                              //  代币获取跳转链接:礼包
	CoinActLink       string                 `protobuf:"bytes,15,opt,name=coin_act_link,json=coinActLink,proto3" json:"coin_act_link,omitempty"`                                                                                                 // 代币获取跳转链接:活动
	Sections          []*Section             `protobuf:"bytes,16,rep,name=sections,proto3" json:"sections,omitempty"`                                                                                                                            // 本期活动幻化皮肤所有组件
}
...
func (*GetInfoRsp_Config) Descriptor() ([]byte, []int) {
	return file_activity_magic_skin_magic_skin_proto_rawDescGZIP(), []int{2, 1}
}
...
func (x *GetInfoRsp_Config) GetCoinPackLink() string {
	if x != nil {
		return x.CoinPackLink
	}
	return ""
}

func (x *GetInfoRsp_Config) GetCoinActLink() string {
	if x != nil {
		return x.CoinActLink
	}
	return ""
}
...
var file_activity_magic_skin_magic_skin_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x6e, 0x74, 0x1a, 0xe7, 0x06, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x1d, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x74, 0x42, 0x35, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x2e, 0x31, 0x37, 0x7a, 0x6a, 0x68, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x6e, 0x61, 0x6b, 0x65, 0x2f, 0x73, 0x6e, 0x61, 0x6b, 0x65, 0x5f,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x61, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x2f, 0x6d,
	0x61, 0x67, 0x69, 0x63, 0x5f, 0x73, 0x6b, 0x69, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_activity_magic_skin_magic_skin_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_activity_magic_skin_magic_skin_proto_goTypes = []interface{}{
	(*Section)(nil),             // 0: magic_skin.Section
	(*GetInfoReq)(nil),          // 1: magic_skin.GetInfoReq
	(*GetInfoRsp)(nil),          // 2: magic_skin.GetInfoRsp
	(*Skin)(nil),                // 3: magic_skin.Skin
	(*TopListItem)(nil),         // 4: magic_skin.TopListItem
	(*LockSectionReq)(nil),      // 5: magic_skin.LockSectionReq
	(*LockSectionRsp)(nil),      // 6: magic_skin.LockSectionRsp
	(*RefreshSkinReq)(nil),      // 7: magic_skin.RefreshSkinReq
	(*RefreshSkinRsp)(nil),      // 8: magic_skin.RefreshSkinRsp
	(*SaveSkinReq)(nil),         // 9: magic_skin.SaveSkinReq
	(*SaveSkinRsp)(nil),         // 10: magic_skin.SaveSkinRsp
	(*RestoreSkinReq)(nil),      // 11: magic_skin.RestoreSkinReq
	(*RestoreSkinRsp)(nil),      // 12: magic_skin.RestoreSkinRsp
	(*GetTopListReq)(nil),       // 13: magic_skin.GetTopListReq
	(*GetTopListRsp)(nil),       // 14: magic_skin.GetTopListRsp
	(*GetInfoRsp_DescItem)(nil), // 15: magic_skin.GetInfoRsp.DescItem
	(*GetInfoRsp_Config)(nil),   // 16: magic_skin.GetInfoRsp.Config
	nil,                         // 17: magic_skin.GetInfoRsp.Config.ExtraCostCoinEntry
	nil,                         // 18: magic_skin.GetInfoRsp.Config.UnlockSectionEntry
}
var file_activity_magic_skin_magic_skin_proto_depIdxs = []int32{
	16, // 0: magic_skin.GetInfoRsp.config:type_name -> magic_skin.GetInfoRsp.Config
	4,  // 1: magic_skin.GetInfoRsp.top_list:type_name -> magic_skin.TopListItem
	3,  // 2: magic_skin.GetInfoRsp.save_skins:type_name -> magic_skin.Skin
	3,  // 3: magic_skin.GetInfoRsp.pending_skin:type_name -> magic_skin.Skin
	3,  // 4: magic_skin.GetInfoRsp.last_skin:type_name -> magic_skin.Skin
	0,  // 5: magic_skin.Skin.sections:type_name -> magic_skin.Section
	3,  // 6: magic_skin.TopListItem.skin:type_name -> magic_skin.Skin
	3,  // 7: magic_skin.RefreshSkinRsp.skin:type_name -> magic_skin.Skin
	3,  // 8: magic_skin.SaveSkinRsp.current_skin:type_name -> magic_skin.Skin
	4,  // 9: magic_skin.GetTopListRsp.list:type_name -> magic_skin.TopListItem
	15, // 10: magic_skin.GetInfoRsp.Config.desc:type_name -> magic_skin.GetInfoRsp.DescItem
	17, // 11: magic_skin.GetInfoRsp.Config.extra_cost_coin:type_name -> magic_skin.GetInfoRsp.Config.ExtraCostCoinEntry
	18, // 12: magic_skin.GetInfoRsp.Config.unlock_section:type_name -> magic_skin.GetInfoRsp.Config.UnlockSectionEntry
	0,  // 13: magic_skin.GetInfoRsp.Config.sections:type_name -> magic_skin.Section
