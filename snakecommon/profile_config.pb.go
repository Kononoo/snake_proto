...
type CPCMilestone struct {
	...
	Level  int32  `protobuf:"varint,1,opt,name=level,proto3" json:"level,omitempty"`  // 里程碑等级
	Mark   string `protobuf:"bytes,2,opt,name=mark,proto3" json:"mark,omitempty"`     // 里程碑标记
	Prompt string `protobuf:"bytes,3,opt,name=prompt,proto3" json:"prompt,omitempty"` // 里程碑提示文案
}
...
var file_snakecommon_profile_config_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x22, 0x50, 0x0a, 0x0c, 0x43, 0x50, 0x43, 0x4d, 0x69,
	0x6c, 0x65, 0x73, 0x74, 0x6f, 0x6e, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x65, 0x76, 0x65, 0x6c,
	...
	0x6b, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x72, 0x6f, 0x6d, 0x70, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28,
